...
function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['home', 'about', 'skills', 'projects', 'model', 'contact'];
    ...
    <div className="min-h-screen bg-black text-white font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex-shrink-0">
              <img src="public\images\mcc.jpg" alt="Logo" className="h-10 w-auto" />
            </div>
            
            {/* Desktop Menu */}
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                {['Home', 'About', 'Skills', 'Projects', 'Model', 'Contact'].map((item) => (
                  <button
                    key={item}
      ...
      <section id="skills" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">
              My <span className="text-[rgb(211,119,43)]">Skills</span>
            </h2>
            <div className="w-24 h-1 bg-[rgb(211,119,43)] mx-auto"></div>
          </div>
            ...
            {skills.map((skill, index) => (
              <div key={index} className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[rgb(211,119,43)]">{skill.level}%</span>
                </div>
                <div className="h-5 bg-gray-700 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-gradient-to-r from-red-500 to-[rgb(211,119,43)] rounded-full transition-all duration-1000 ease-out"
          ...
          <div className="mt-16 grid md:grid-cols-2 gap-8">
            <div className="bg-gray-800/50 rounded-xl p-8">
              <h3 className="text-2xl font-bold mb-6 text-[rgb(211,119,43)]">Interests</h3>
              <div className="flex flex-wrap gap-3">
                {['Travel', 'Cricket', 'Editing'].map((interest, index) => (
                  <span
                    key={index}
                    className="px-4 py-2 bg-gray-700 rounded-full text-sm hover:bg-[rgb(211,119,43)] hover:text-white transition-colors cursor-default"
                  >
                    {interest}
                  </span>
                ))}
            ...
            <div className="bg-gray-800/50 rounded-xl p-8">
              <h3 className="text-2xl font-bold mb-6 text-[rgb(211,119,43)]">Soft Skills</h3>
              <div className="flex flex-wrap gap-3">
                {['Active Listener', 'Creativity', 'Teamwork'].map((skill, index) => (
                  <span
                    key={index}
                    className="px-4 py-2 bg-gray-700 rounded-full text-sm hover:bg-[rgb(211,119,43)] hover:text-white transition-colors cursor-default"
                  >
          ...
          <div className="mt-12 text-center">
            <h3 className="text-2xl font-bold mb-6">
              <span className="text-[rgb(211,119,43)]">Certificates</span>
            </h3>
            <div className="inline-block bg-gradient-to-r from-[rgb(211,119,43)]/20 to-orange-500/20 rounded-xl p-6 border border-[rgb(211,119,43)]/30">
              <p className="text-lg font-semibold">Crack ED Upskilling Program</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* 3D Model Section */}
      <section id="model" className="py-20 bg-gray-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
              Interactive <span className="text-[rgb(211,119,43)]">3D Model</span>
            </h2>
            <p className="text-gray-400 text-lg">Move your cursor to interact with the 3D model</p>
          </div>
          <div className="bg-gray-800 rounded-lg overflow-hidden shadow-2xl">
            <ModelViewer 
              sketchfabModelUrl="/models/scene.gltf"
              height="600px" 
            />
          </div>
        </div>
